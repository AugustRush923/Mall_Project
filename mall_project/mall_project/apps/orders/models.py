...
class OrderInfo(models.Model):
    ...
    address = models.ForeignKey(Address, on_delete=models.PROTECT, verbose_name="收货地址ID")
    ...
    pay_method = models.PositiveSmallIntegerField(choices=PAY_METHOD_CHOICES, default=1, verbose_name="支付方式")
    status = models.PositiveSmallIntegerField(choices=ORDER_STATUS_CHOICES, default=1, verbose_name="订单状态")
...
class OrderGoods(models.Model):
    ...
    score = models.PositiveSmallIntegerField(choices=SCORE_CHOICES, default=5, verbose_name="满意度评分")
